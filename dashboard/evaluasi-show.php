...
if (isset($_GET['search_query'])) {
    ...
    $total_records_query = mysqli_query($conn, "SELECT COUNT(*) AS total FROM tbl_evaluasi_pelatihan JOIN tbl_peserta ON tbl_evaluasi_pelatihan.id_peserta = tbl_peserta.id_peserta WHERE tbl_peserta.nama_peserta LIKE '%$searchQuery%' AND tbl_evaluasi_pelatihan.id_pelatihan = '$id_pelatihan'");
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="breadcrumb-container">
                                        <h3 class="mt-4"><b>Data Evaluasi Pelatihan - <?php echo htmlspecialchars($nama_pelatihan); ?> (<?php echo date("d F Y", strtotime($tgl_pelatihan)); ?>)</b></h3>
                                        <ol class="breadcrumb">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row_evaluasi = mysqli_fetch_assoc($result_evaluasi)) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row_evaluasi["testimoni"]; ?></td>
                                                        <td>
                                                            <a href="evaluasi-edit.php?id_evaluasi_pelatihan=<?php echo $row_evaluasi["id_evaluasi_pelatihan"]; ?>" class="btn btn-sm btn-outline-warning btn-fw">Edit</a>
                                                            <a class="btn btn-sm btn-outline-danger btn-fw delete-btn" data-id_evaluasi_pelatihan="<?php echo $row_evaluasi["id_evaluasi_pelatihan"]; ?>" data-id_pelatihan="<?php echo $id_pelatihan; ?>">Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-btn').click(function(e) {
                e.preventDefault();
                var id_evaluasi_pelatihan = $(this).data('id_evaluasi_pelatihan');
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location = `evaluasi-hapus.php?id_evaluasi_pelatihan=${id_evaluasi_pelatihan}&id_pelatihan=${id_pelatihan}`;
                    }
                });
            });
        });
