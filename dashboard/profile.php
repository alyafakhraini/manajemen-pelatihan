...
if (isset($_POST["submit"])) {
    ...
    $simpan = mysqli_query($conn, "UPDATE tbl_user SET username = '$username', password = '$password', profile ='$profile' WHERE id_user = '$id_user'");
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="breadcrumb-container">
                                    <h3 class="mt-4"><b>Profile Akun</b></h3>
                                    <ol class="breadcrumb">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" class="forms-sample">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img src="../profile/<?php echo $row_user["profile"] ?>" alt="Foto Profile Lama" class="img-thumnail" width="100">
                                        </div>
                                    </div>
                                    <div class="form-group row">
