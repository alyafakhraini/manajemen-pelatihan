...
if (isset($_GET["id_pelatihan"])) {
    ...
    $result_performa = mysqli_query($conn, "SELECT C.nama_peserta, T.nama_trainer, H.nilai, H.saran
                                           FROM tbl_kehadiran H, tbl_pendaftaran D, tbl_pelatihan P, tbl_peserta C, tbl_trainer T
                                           WHERE H.id_pendaftaran = D.id_pendaftaran
                                           AND D.id_pelatihan = P.id_pelatihan
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="breadcrumb-container">
                                        <h3 class="mt-4"><b>Laporan Performa Peserta <?php echo isset($_GET['id_pelatihan']) ? ' - ' . $nama_pelatihan : ''; ?></b></h3>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Laporan Performa Peserta</li>
                                        </ol>
                                    </div>
                                    ...
                                    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="GET" class="mb-3 form-inline">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <a href="report-performa.php" class="btn btn-sm btn-secondary ml-2">Reset</a>
                                            </div>
                                        </div>
                                    </form>

                                    <div class="table-responsive">
                                        <?php if (isset($_GET["id_pelatihan"]) && $result_performa && mysqli_num_rows($result_performa) > 0) { ?>
                                            ...
                                            <a href="print-performa.php?id_pelatihan=<?= $id_pelatihan ?>" class="btn btn-primary btn-icon-text" target="_blank">Print PDF<i class="ti-printer btn-icon-append"></i></a>
                                        <?php } elseif (isset($_GET["id_pelatihan"]) && mysqli_num_rows($result_performa) == 0) { ?>
                                            <br>
                                            <h5 style="color: #ec4c3b; font-weight: bold; text-align: center; margin-top: 20px;">
                                                <i class="fas fa-info-circle"></i> Belum ada peserta yang terdata untuk pelatihan ini.
                                            </h5>
                                        <?php } else { ?>
                                            <br>
