                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        while ($row_pelatihan = mysqli_fetch_assoc($result_pelatihan)) {
                                            ...
                                            // Menentukan kelas kartu berdasarkan kategori program
                                            $kategori_program = '';
                                            ...
                                            $query_peserta_terdaftar = "SELECT COUNT(*) AS jumlah_peserta FROM tbl_pendaftaran WHERE id_pelatihan = $id_pelatihan";
                                            $result_peserta_terdaftar = mysqli_query($conn, $query_peserta_terdaftar);
                                            $jumlah_peserta_terdaftar = mysqli_fetch_assoc($result_peserta_terdaftar)['jumlah_peserta'];

                                            $query_peserta_terkonfirmasi = "SELECT COUNT(*) AS total
                                                                            FROM tbl_pendaftaran D, tbl_pelatihan P
                                                                            WHERE D.id_pelatihan = P.id_pelatihan
                                                                            AND P.id_pelatihan = '$id_pelatihan'
                                                                            AND D.status_pembayaran = 'confirmed'";
                                            $result_peserta_konfirmasi = mysqli_query($conn, $query_peserta_terkonfirmasi);
                                            $jumlah_peserta_terkonfirmasi = mysqli_fetch_assoc($result_peserta_konfirmasi)['total'];

                                        ?>
                                            <div class="col-md-3" style="margin-left: 25px;">
                                                <div class="card mb-4 <?php echo $kategori_program; ?>">
                                                    <a href="daftar-show.php?id_pelatihan=<?php echo $row_pelatihan['id_pelatihan']; ?>">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h5><span class="fa fa-users"></span> Peserta Terdaftar = <a><?php echo $jumlah_peserta_terdaftar ?></a></h5>
                                                        <h5><span class="fa fa-check-square"></span> Peserta Terkonfirmasi = <a><?php echo $jumlah_peserta_terkonfirmasi ?></a></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } ?>
