                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-3" style="margin-left: 25px;">
                                                <div class="card mb-4 <?php echo $kategori_program; ?>">
                                                    <a href="kehadiran-show.php?id_pelatihan=<?php echo $row_pelatihan['id_pelatihan']; ?>">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h5><span class="fa fa-users"></span> Peserta Terkonfirmasi = <a><?php echo $jumlah_peserta_terkonfirmasi ?></a></h5>
