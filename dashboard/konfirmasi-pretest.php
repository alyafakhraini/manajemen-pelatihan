...
$update = mysqli_query($conn, "UPDATE tbl_konfirmasi_test SET status_pre = 'done' WHERE id_konfirmasi = '$id_konfirmasi'");
              ...
              <body>
                  ...
                  <script>
                      Swal.fire({
                          icon: "success",
                          title: "Berhasil!",
                          text: "Pengisian Pre-Test berhasil dikonfirmasi.",
          ...
          <body>
              ...
              <script>
                  Swal.fire({
                      icon: "error",
                      title: "Oops...",
                      text: "Terjadi kesalahan saat mengkonfirmasi pengisian Pre-Test.",
                      showConfirmButton: false,
                      timer: 1500
                  }).then(() => {
                      window.location = "test-pengisian.php?id_pelatihan=' . $id_pelatihan . '";
