...
$total_records_query = mysqli_query($conn, "SELECT COUNT(*) AS total
                                            FROM tbl_test T, tbl_pelatihan P
                                            WHERE T.id_pelatihan = P.id_pelatihan");

$total_records = mysqli_fetch_assoc($total_records_query)['total'];

$result_pre_query = "SELECT T.id_test, T.pertanyaan1, T.pertanyaan2, T.pertanyaan3, T.pertanyaan4, T.pertanyaan5, P.nama_pelatihan, P.kategori_program
                    FROM tbl_test T, tbl_pelatihan P
                    WHERE T.id_pelatihan = P.id_pelatihan
                    LIMIT $mulai, $limit";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="breadcrumb-container">
                                        <h3 class="mt-4"><b>Data Test Peserta</b></h3>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Data Test Peserta</li>
                                        </ol>
                                    </div>

                                    <a href="test-tambah.php" class="btn btn-outline-primary btn-fw">Tambah Data</a>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row_pre = mysqli_fetch_assoc($result_pre)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                            // Menetapkan kategori_program
                                                            $kategori_program = $row_pre['kategori_program'];

                                                            // Menggunakan switch untuk menentukan teks kategori_program
                                                            ...
                                                            // Menampilkan kategori_program_text dan nama_pelatihan
                                                            echo $kategori_program_text . ': ' . $row_pre['nama_pelatihan'];
                                                            ?>
                                                        </td>
                                                        <td><?php echo $row_pre["pertanyaan1"]; ?></td>
                                                        <td><?php echo $row_pre["pertanyaan2"]; ?></td>
                                                        <td><?php echo $row_pre["pertanyaan3"]; ?></td>
                                                        <td><?php echo $row_pre["pertanyaan4"]; ?></td>
                                                        <td><?php echo $row_pre["pertanyaan5"]; ?></td>
                                                        <td>
                                                            <a href="test-edit.php?id_test=<?php echo $row_pre["id_test"]; ?>" class="btn btn-sm btn-outline-warning btn-fw">Edit</a>
                                                            <a class="btn btn-sm btn-outline-danger btn-fw delete-btn" data-id_test="<?php echo $row_pre["id_test"]; ?>">Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
            ...
            $('.delete-btn').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location = `test-hapus.php?id_test=${id_test}`;
                    }
                });
            });
        });
