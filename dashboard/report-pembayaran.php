...
if (isset($_GET["id_pelatihan"])) {
    ...
    $result_pembayaran = mysqli_query($conn, "SELECT C.nama_peserta, D.tgl_daftar, D.metode_pembayaran, D.jml_pembayaran, D.status_pembayaran, C.email
...
<head>
    ...
    <title> Laporan Pembayaran Pendaftaran</title>
    <!-- plugins:css -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="breadcrumb-container">
                                        <h3 class="mt-4"><b>Laporan Pembayaran Pendaftaran <?php echo isset($_GET['id_pelatihan']) ? ' - ' . $nama_pelatihan : ''; ?></b></h3>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Laporan Pembayaran Pendaftaran</li>
                                        </ol>
                                    </div>
                                    ...
                                    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="GET" class="mb-3 form-inline">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <a href="report-pembayaran.php" class="btn btn-sm btn-secondary ml-2">Reset</a>
                                            </div>
                                        </div>
                                    </form>

                                    <div class="table-responsive">
                                        <?php if (isset($_GET["id_pelatihan"]) && $result_pembayaran && mysqli_num_rows($result_pembayaran) > 0) { ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row_pembayaran = mysqli_fetch_assoc($result_pembayaran)) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row_pembayaran["email"]; ?></td>
                                                            <td>
                                                                <?php
                                                                if (isset($row_pembayaran["tgl_daftar"])) {
                                                                    $tgl_daftar = $row_pembayaran["tgl_daftar"];
                                            ...
                                            <a href="print-pembayaran.php?id_pelatihan=<?= $id_pelatihan ?>" class="btn btn-primary btn-icon-text" target="_blank">Print PDF <i class="ti-printer btn-icon-append"></i></a>
                                        <?php } elseif (isset($_GET["id_pelatihan"]) && mysqli_num_rows($result_pembayaran) == 0) { ?>
                                            <br>
                                            <h5 style="color: #ec4c3b; font-weight: bold; text-align: center; margin-top: 20px;">
                                                <i class="fas fa-info-circle"></i> Belum ada peserta yang terdata untuk pembayaran ini.
                                            </h5>
                                        <?php } else { ?>
                                            <br>
