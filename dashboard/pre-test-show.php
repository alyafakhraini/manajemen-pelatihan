...
if ($id_pelatihan > 0) {
    ...
    if (!$result_pre) {
        die("Error: Gagal mengambil data pre-test. " . mysqli_error($conn));
    }
...
<head>
    ...
    <title> Jawaban Pre-Test Peserta</title>
    <!-- plugins:css -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="breadcrumb-container">
                                        <h3 class="mt-4"><b>Jawaban Pre-Test Peserta - <?php echo htmlspecialchars($nama_pelatihan); ?> (<?php echo date("d F Y", strtotime($tgl_pelatihan)); ?>)</b></h3>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="pre-pelatihan-list.php">Pilih Pelatihan</a></li>
                                            <li class="breadcrumb-item active">Jawaban Pre-Test Peserta - <?php echo htmlspecialchars($nama_pelatihan); ?></li>
                                        </ol>
                                    </div>
