...
if (isset($_GET["keahlian"])) {
    ...
    $result_trainer = mysqli_query($conn, "SELECT * FROM tbl_trainer WHERE keahlian = '$keahlian' LIMIT $mulai, $limit");
} else {
    $total_records = 0;
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <select name="keahlian" id="keahlian" class="form-control" required>
                                                        <option value="">-- Pilih Keahlian Trainer --</option>
                                                        <?php
                                                        $query_trainer = mysqli_query($conn, "SELECT DISTINCT keahlian FROM tbl_trainer");
                                                        while ($row_trainer = mysqli_fetch_assoc($query_trainer)) {
                                                            echo '<option value="' . $row_trainer['keahlian'] . '">' . $row_trainer['keahlian'] . '</option>';
                                                        }
                                                        ?>
                                                    </select>
                                    ...
                                    <div class="table-responsive">
                                        <?php if ($result_trainer && mysqli_num_rows($result_trainer) > 0) { ?>
                                            ...
                                            <a href="print-trainer.php?keahlian=<?= $keahlian ?>" class="btn btn-primary btn-icon-text" target="_blank">Print PDF<i class="ti-printer btn-icon-append"></i></a>
                                        <?php } elseif (isset($_GET["keahlian"]) && mysqli_num_rows($result_trainer) == 0) { ?>
                                            <br>
