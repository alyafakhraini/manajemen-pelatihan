...
<head>
    ...
    <title> Laporan Keuangan Pelatihan Per Kategori Transaksi</title>
    <!-- plugins:css -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="breadcrumb-container">
                                        <h3 class="mt-4"><b>Laporan Keuangan Pelatihan Per Kategori Transaksi <?php echo isset($_GET['id_pelatihan']) ? ' - ' . $nama_pelatihan : ''; ?></b></h3>
                                        <ol class="breadcrumb">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <select name="kategori_transaksi" id="kategori_transaksi" class="form-control" required>
                                                        ...
                                                        <option value="pendapatan" <?php echo ($kategori_transaksi == 'pendapatan') ? 'selected' : ''; ?>>Pendapatan</option>
                                                        <option value="pengeluaran" <?php echo ($kategori_transaksi == 'pengeluaran') ? 'selected' : ''; ?>>Pengeluaran</option>
                                                    </select>
                                                    <span class="input-group-text">
                                                        <i class="fas fa-caret-down"></i>
                                                    </span>
                                    ...
                                    <div class="table-responsive">
                                        <?php if (isset($kategori_transaksi)) : ?>
                                            <?php if ($total_records > 0) : ?>
                                                ...
                                                <a href="print-keuangan-kategori.php?id_pelatihan=<?= $id_pelatihan ?>&kategori_transaksi=<?= $kategori_transaksi ?>" class="btn btn-primary btn-icon-text" target="_blank">Print PDF<i class="ti-printer btn-icon-append"></i></a>
                                            <?php else : ?>
                                                <br>
