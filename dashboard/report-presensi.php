                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="breadcrumb-container">
                                        <h3 class="mt-4"><b>Laporan Presensi Peserta<?php echo isset($_GET['id_pelatihan']) ? ' - ' . $nama_pelatihan : ''; ?></b></h3>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Presensi Pelatihan</li>
                                        </ol>
                                    </div>
                                    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="GET" class="mb-3 form-inline">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <a href="report-presensi.php" class="btn btn-sm btn-secondary ml-2">Reset</a>
                                            </div>
                                        </div>
                                    </form>

                                    <div class="table-responsive">
                                        <?php if (isset($_GET["id_pelatihan"]) && $result_presensi && mysqli_num_rows($result_presensi) > 0) { ?>
                                            ...
                                            <a href="print-presensi.php?id_pelatihan=<?= $id_pelatihan ?>" class="btn btn-primary btn-icon-text" target="_blank">Print PDF <i class="ti-printer btn-icon-append"></i></a>
