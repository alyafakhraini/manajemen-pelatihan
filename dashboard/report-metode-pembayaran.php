...
if ($id_pelatihan && $metode_pembayaran) {
    ...
    if ($query_nama_pelatihan) {
        $nama_pelatihan_row = mysqli_fetch_assoc($query_nama_pelatihan);
        $nama_pelatihan = $nama_pelatihan_row['nama_pelatihan'];
    } else {
        $nama_pelatihan = "";
    }
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="breadcrumb-container">
                                        <h3 class="mt-4"><b>Laporan Metode Pembayaran Pendaftaran <?php echo isset($_GET['id_pelatihan']) ? ' - ' . $nama_pelatihan : ''; ?></b></h3>
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Laporan Metode Pembayaran Pendaftaran</li>
                                        </ol>
                                    </div>
                                    ...
                                    <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="GET" class="mb-3 form-inline">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="input-group">
                                                    <select name="metode_pembayaran" id="metode_pembayaran" class="form-control" required>
                                                        ...
                                                        <option value="tf" <?php echo ($metode_pembayaran == 'tf') ? 'selected' : ''; ?>>Transfer (Mandiri an. YHC)</option>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                <a href="report-metode-pembayaran.php" class="btn btn-sm btn-secondary ml-2">Reset</a>
                                            </div>
                                        </div>
                                    </form>

                                    <div class="table-responsive">
                                        <?php if (isset($metode_pembayaran)) : ?>
                                            <?php if ($total_records > 0) : ?>
                                                ...
                                                <a href="print-metode-pembayaran.php?id_pelatihan=<?= $id_pelatihan ?>&metode_pembayaran=<?= $metode_pembayaran ?>" class="btn btn-primary btn-icon-text" target="_blank">Print PDF <i class="ti-printer btn-icon-append"></i></a>
                                            <?php else : ?>
                                                <br>
                                        ...
                                        <?php else : ?>
                                            ...
                                            <h5 style="color: #007bff; font-weight: bold; text-align: center; margin-top: 20px;">
                                                <i class="fas fa-info-circle"></i> Silahkan pilih pelatihan & metode pembayaran untuk melihat data!
                                            </h5>
                                        <?php endif; ?>
                                    </div>
