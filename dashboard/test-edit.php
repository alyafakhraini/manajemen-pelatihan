...
$result_test = mysqli_query($conn, "SELECT test.*, pelatihan.nama_pelatihan, pelatihan.kategori_program
                                    FROM tbl_test AS test
                                    JOIN tbl_pelatihan AS pelatihan ON test.id_pelatihan = test.id_pelatihan
                                    WHERE id_test = '$id_test'");
$row_test = mysqli_fetch_assoc($result_test);

$selected_id_pelatihan = $row_test["id_pelatihan"];
...
if (isset($_POST["submit"])) {
    ...
    $edit = mysqli_query($conn, "UPDATE tbl_test SET id_pelatihan = '$id_pelatihan', pertanyaan1 = '$pertanyaan1', pertanyaan2 = '$pertanyaan2', pertanyaan3 = '$pertanyaan3', pertanyaan4 = '$pertanyaan4', pertanyaan5 ='$pertanyaan5' WHERE id_test = '$id_test'");
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="breadcrumb-container">
                                    <h3 class="mt-4"><b>Edit Data Test</b></h3>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="test-show.php">Data Test</a></li>
                                        <li class="breadcrumb-item active">Edit Data Test</li>
                                    </ol>
                                </div>
                                <form action="" method="post" enctype="multipart/form-data" class="forms-sample">
                                            ...
                                            <div class="input-group">
                                                <select name="id_pelatihan" id="id_pelatihan" class="form-control" required>
                                                    ...
                                                    while ($row_pelatihan = mysqli_fetch_assoc($query_pelatihan)) {
                                                        ...
                                                        $selected = ($row_pelatihan['id_pelatihan'] == $selected_id_pelatihan) ? 'selected' : '';
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="pertanyaan1" name="pertanyaan1" rows="10" required><?php echo $row_test["pertanyaan1"]; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="pertanyaan2" class="col-sm-2 col-form-label">Pertanyaan 2</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="pertanyaan2" name="pertanyaan2" rows="10" required><?php echo $row_test["pertanyaan2"]; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="pertanyaan3" class="col-sm-2 col-form-label">Pertanyaan 3</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="pertanyaan3" name="pertanyaan3" rows="10" required><?php echo $row_test["pertanyaan3"]; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="pertanyaan4" class="col-sm-2 col-form-label">Pertanyaan 4</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="pertanyaan4" name="pertanyaan4" rows="10" required><?php echo $row_test["pertanyaan4"]; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="pertanyaan5" class="col-sm-2 col-form-label">Pertanyaan 5</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="pertanyaan5" name="pertanyaan5" rows="10" required><?php echo $row_test["pertanyaan5"]; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-10 offset-sm-2">
                                            <button type="submit" name="submit" class="btn btn-primary me-2">Edit</button>
                                            <a href="test-show.php" class="btn btn-light">Cancel</a>
                                        </div>
                                    </div>
