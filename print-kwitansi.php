...
if (isset($_GET["id_pelatihan"]) & isset($_GET["id_peserta"])) {
    ...
    $result_performa = mysqli_query($conn, "SELECT C.nama_peserta, D.tgl_daftar, D.metode_pembayaran, D.jml_pembayaran, D.status_pembayaran, C.email
                ...
                <div class="content">
                    ...
                    <section>
                        <div class="receipt-container">
                            ...
                            <?php if ($result_performa && mysqli_num_rows($result_performa) > 0):
                                $row_performa = mysqli_fetch_assoc($result_performa); ?>
