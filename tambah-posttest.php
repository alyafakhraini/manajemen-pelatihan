...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $simpan = "INSERT INTO tbl_posttest (id_pelatihan, id_peserta, jawaban1, jawaban2, jawaban3, jawaban4, jawaban5) 
...
$sql_check_kehadiran = "SELECT H.id_kehadiran
                        FROM tbl_kehadiran H, tbl_pendaftaran D
...
$form_visible = (mysqli_num_rows($result_check_kehadiran) === 0);

// Memeriksa apakah peserta sudah mengisi form evaluasi
$sql_check = "SELECT * FROM tbl_posttest WHERE id_pelatihan = $id_pelatihan AND id_peserta = $id_peserta";
...
<head>
    ...
    <title>Form Post-Test: <?php echo htmlspecialchars($row_pelatihan['nama_pelatihan']); ?></title> <!-- Bootstrap CSS -->
                    ...
                    <div class="col-lg-6">
                        <div class="banner_content text-center">
                            ...
                            <div class="page_link">
                                ...
                                <a href="tambah-posttest.php">Form Post-Test</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="main_title">
                        <h2 class="mb-3"> Form Post-Test</h2>
                        <p>
            ...
            <div class="row">
                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="title">
                                Form Post-Test - <?php echo htmlspecialchars(getKategoriProgramText($row_pelatihan['kategori_program']) . " : " . $row_pelatihan["nama_pelatihan"]); ?>
                            </h2>
                            ...
                            <?php elseif ($form_submitted) : ?>
                                <div class="alert alert-info text-center" role="alert">
                                    Terima kasih telah mengisikan Post-Test untuk pelatihan ini. Form Post-Test berhasil disubmit, silakan kembali ke <a href="my-course.php" class="alert-link">Pelatihan Saya</a>.
                                <?php elseif ($form_visible) : ?>
                                    <div class="alert alert-warning text-center" role="alert">
                                        Anda tidak menghadiri pelatihan ini, sehingga tidak bisa mengisi form Post-Test.
                                    <?php else : ?>
                                        ...
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?id_pelatihan=$id_pelatihan"; ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 mt-3 mb-5 text-center">
                                                    <span><strong>
                                                            Post-test ini bertujuan untuk menilai pemahaman Anda setelah mengikuti pelatihan. Jawablah setiap pertanyaan dengan jujur, karena hasil post-test akan membantu kami mengevaluasi tingkat kemajuan Anda selama pelatihan. Perbandingan antara pre-test dan post-test akan menunjukkan peningkatan pengetahuan dan efektivitas pelatihan.

                                                            Hasil post-test Anda dapat dilihat pada bagian Performa di Pelatihan Saya.
                                                        </strong></span>
                                                </div>
                                            </div>
